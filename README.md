...
- June 5 L1 snapshot: public REST checks showed `kaspa-mainnet`, virtual DAA 452,435,711, about 27.488 billion KAS from the supply endpoint, and 2.59565436 KAS per block. Recheck exact values before quoting.
