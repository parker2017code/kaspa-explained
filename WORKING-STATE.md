...
11. **DATA COLLECTED THIS SESSION, all in `data/`, all read visually with no API.** `aa-all-status-2026-08-20.md` is the big one: 610 models, Status filter set to All, 41 columns, 54 families with two or more settings. Also `arena-text-all-categories-2026-08-20.md` (29 categories plus Style Control and Factuality variants), `livebench-historical-2026-08-20.md` (PARTIAL: the agent died on an API error while adding 2026-01-08. It has 2025-05-30 and 2025-11-25. It was resumed; verify what is actually in the file before trusting it), `livebench-subtasks-2026-08-20.md` (all 23 components, 44 models, cross-checked two ways), `arena-agent-categories-2026-08-20.md` (Overall/Code/Chat/Work at 50 rows each plus all five signal tables), `arena-extra-2026-08-20.md` (Vision Arena's 9 undocumented sub-categories), `aa-extra-2026-08-20.md` (AA-Briefcase, AutomationBench, Harvey LAB, EnterpriseOps-Gym), `livebench-extra-2026-08-20.md`, `tier-audit-2026-08-20.md`.

12. **NOT YET WIRED IN. This is the main open work.** The ladder currently fits on the 10 AA families reachable from `picker-data.json`. The 54 families in `aa-all-status-2026-08-20.md` are not parsed into the pipeline. Neither are the LiveBench historical releases, the Arena text categories, or the Arena agent sub-boards. Wiring those in is the single highest-value next step and every constant in items 4 through 7 should be refit once they are.
