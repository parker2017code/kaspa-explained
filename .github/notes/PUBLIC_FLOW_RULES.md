...
Use this when changing Kaspa Explained public pages.

## Default Reader

Assume the first reader is smart but does not already hold the crypto context.

Lead with:

1. What Kaspa is useful for.
2. What is live today.
3. What builders can try next.
4. Where covenants, based apps, and later vProgs fit.
...
- Light mode should be available.
- Avoid robotic dashboard styling.
- Favor warm surfaces, clear buttons, and short sections with deeper material linked or collapsed.
