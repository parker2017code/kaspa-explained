...
- September 8, 2026 owner cancellation: V5 and V6 are withdrawn. Keep `/covenants` and the existing public site available. Do not resume V5/V6 work, restore their routes, enable their APIs, or recreate the V6 container without a new explicit user request. Source and saved wallet state are retained.
