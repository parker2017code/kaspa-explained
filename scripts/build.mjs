...
if(!standalone){
  ...
  for(const name of ['v6-browser-wallet.mjs','v6-browser-engine.mjs','v6-browser-ui.mjs','v6-browser-lessons.mjs','v6-browser.css','v6-proof-core.mjs','v6-proof-templates.json','v5-ring-protocol.mjs','v5-delivery-protocol.mjs','v5-advanced-templates.json','v6-app.mjs','v6-progress.mjs','v6-ui.mjs','v6-lessons.mjs','v6-world.mjs','v6-world-assets.mjs','v6-dag.mjs','v6.css'])await copyFile(`src/${name}`,`${output}/assets/${name}`);
...
for(const name of ['favicon.svg','favicon.ico','favicon.png','og-kaspa-explained.png','satoshis-engine.pdf','the-instrument.pdf','LICENSE.md','THIRD_PARTY.md'])await copyFile(name,`${output}/${name}`);
